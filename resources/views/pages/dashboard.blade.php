                        ...
                        <tbody>
                            @foreach ($articles as $article)
                                <tr class="border-b border-secondary/30">
                                    ...
                                    <td class="p-4">{{ Str::limit($article->title, 50) }}</td>
                                    <td class="p-4">
                            ...
                            @foreach ($feedbacks as $feedback)
                                <tr class="border-b border-secondary/30 @if(!$feedback->is_read) bg-secondary/20 @endif">
                                    ...
                                    <td class="p-4 text-right">
                                        ...
                                        <form method="POST" action="{{ route('feedback.destroy', $feedback->id) }}" class="inline ml-4" onsubmit="return confirm('Hapus feedback ini?');">
                                            @csrf @method('DELETE')
                                            <button type="submit" class="text-red-500 hover:text-red-700 font-bold">Delete</button>
                                        </form>
                                    </td>
